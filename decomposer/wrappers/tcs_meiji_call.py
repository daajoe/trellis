...
# TODO:
def compute_decomp(instance,timeout=30):
    solver_name = os.path.join(os.path.expanduser("~"), 'src/treewidth-portfolio/solvers/exact/tcs-meiji/tw-exact')
    call = 'timeout %i %s < %s' % (timeout,solver_name, instance)
    sys.stderr.write('%s\n' % call)
